...
import gov.fnal.eag.dtucker.desPhotoStds.PhotomEqSolverDC5;
 ...
 *
 */
public class PhotomEqSolverRunDC5 {
	
	private static void printUsage(boolean error) {

		PhotomEqSolverDC5 ph = new PhotomEqSolverDC5();
        
		// Grab default values from PhotomEqSolverDC5...
    ...
    public static void main (String[] args) throws Exception {
        ...
        // Instantiate an instance of the PhotomEqSolverDC5 class...
        PhotomEqSolverDC5 ph = new PhotomEqSolverDC5();

        // Grab default values for parameters from PhotomEqSolverDC5...
		String urlDefault             = ph.getUrl();
        String dbNameDefault          = ph.getDbName();
        String userDefault            = ph.getUser();
        String passwdDefault          = ph.getPasswd();
        ...
        // These values take precedence over those hardwired in the PhotomEqSolverDC5 code, 
    	...
    	// Set the instance variables for the PhotomEqSolverDC5 object ph using the values 
    	// determined above...
    	if (localVerbose > 0) {
