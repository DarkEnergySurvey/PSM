 ...
 * 
 */
public class PhotomEqSolverDC4 {
	...
	private String psmVersion = "v_DC4";
	...
	public void solve() throws Exception {
		...
		String query2 = "SELECT CCD FROM " + imageTable + " i, "
		...
		if (verbose == 1 && debug) {
			System.out.println("Since debug option was set, the " + fitTable + " table will not be updated.");
			System.out.println("");
		}
