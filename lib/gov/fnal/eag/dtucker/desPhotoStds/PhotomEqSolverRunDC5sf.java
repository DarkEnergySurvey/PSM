/**
 * PhotomEqSolverRunDC5.java   The DES Collaboration, 29 July 2009
 *                             Updated: 4 September 2009
 */

package gov.fnal.eag.dtucker.desPhotoStds;

import gov.fnal.eag.dtucker.desPhotoStds.PhotomEqSolverDC5sf;
 ...
 *
 */
public class PhotomEqSolverRunDC5sf {
	
	private static void printUsage(boolean error) {

		PhotomEqSolverDC5sf ph = new PhotomEqSolverDC5sf();
        
		// Grab default values from PhotomEqSolverDC5sf...
        ...
        String message = 
       			"\nUsage:  java gov.fnal.eag.dtucker.desPhotoStds.PhotomEqSolverRunDC5 [OPTIONS] \n\n" +
				"   OPTIONS: \n" + 
				"   --paramFile VALUE             name of (optional) parameter file \n" + 
				"                                 values for parameters in the paramFile will override values hardwired into the PSMDC5 code \n" +
				...
				"      java gov.fnal.eag.dtucker.desPhotoStds.PhotomEqSolverRunDC5 -P BCS -n 20061223 -f g --ccdid 0 --magLo 15.0 --magHi 18.0 --niter 3 --nsigma 2.5 --imageType remap --imageNameFilter % --run 20080324000000_20061223 --psmVersion v_DC5 -v 2 --bsolve --ksolve \n\n" +
				"   Example 2: \n" +
				"      java gov.fnal.eag.dtucker.desPhotoStds.PhotomEqSolverRunDC5 --user myUserName -p myPassword -P BCS -n 20061223 -f g -v 2 --ksolve \n\n" + 
				"   Example 2a (with .desdm file): \n" +
				"      java gov.fnal.eag.dtucker.desPhotoStds.PhotomEqSolverRunDC5 -P BCS -n 20061223 -f g -v 2 --ksolve \n\n" + 
				"   Example 3: \n" +
				"      java gov.fnal.eag.dtucker.desPhotoStds.PhotomEqSolverRunDC5 --user myUserName -p myPassword -P BCS --paramFile /home/myname/psmParam.par \n\n" + 
				"   Example 3a (with .desdm file): \n" +
				"      java gov.fnal.eag.dtucker.desPhotoStds.PhotomEqSolverRunDC5 -P BCS --paramFile /home/myname/psmParam.par \n\n" + 
				"   Example 4: \n" +
				"      java gov.fnal.eag.dtucker.desPhotoStds.PhotomEqSolverRunDC5 --user myUserName -p myPassword -P BCS -n 20061223 -f g -v 2 --ksolve  --paramFile /home/myname/psmParam.par \n\n" + 
				"   Example 4a (with .desdm file): \n" +
				"      java gov.fnal.eag.dtucker.desPhotoStds.PhotomEqSolverRunDC5 -P BCS -n 20061223 -f g -v 2 --ksolve  --paramFile /home/myname/psmParam.par \n\n" + 
				"   Example 5 (no .desdm file required): \n" + 
				"      java gov.fnal.eag.dtucker.desPhotoStds.PhotomEqSolverRunDC5 --help \n\n";
    ...
    public static void main (String[] args) throws Exception {
        ...
        // Instantiate an instance of the PhotomEqSolverDC5sf class...
        PhotomEqSolverDC5sf ph = new PhotomEqSolverDC5sf();

        // Grab default values for parameters from PhotomEqSolverDC5sf...
		String urlDefault             = ph.getUrl();
        String dbNameDefault          = ph.getDbName();
        String userDefault            = ph.getUser();
        String passwdDefault          = ph.getPasswd();
        ...
        // These values take precedence over those hardwired in the PhotomEqSolverDC5sf code, 
		...
		// Instantiate a CmdLineParser to read in the arguments pass to PhotomEqSolverRunDC5...
    	...
    	// Set the instance variables for the PhotomEqSolverDC5sf object ph using the values 
    	// determined above...
    	if (localVerbose > 0) {
